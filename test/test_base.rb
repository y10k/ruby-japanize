  ...
  部(:試験) {
    ...
    組(:核の操作の試験, 原型: 試験単位::試験事例) {
      ...
      資料('__呼び出し先__'                   => [ :__呼び出し先__,                   :__callee__ ],
           ...
           '行出力'                           => [ :行出力,                           :puts ],
           '乱数'                             => [ :乱数,                             :rand ],
           '行を読み取る'                     => [ :行を読み取る,                     :readline ],
           '全行を読み取る'                   => [ :全行を読み取る,                   :readlines ],
    ...
    組(:各種操作を日本語化できることの試験, 原型: 試験単位::試験事例) {
      ...
      試験(:繰り返し操作を日本語化できることを確認) {|資料|
        繰り返しの一覧, 日本語の繰り返し操作, 本来の繰り返し操作 = 資料
        ...
        等しいことを確認(繰り返しの一覧, 配列(ある物.列挙する(日本語の繰り返し操作)))
        等しいことを確認(繰り返しの一覧, 配列(ある物.列挙する(本来の繰り返し操作)))
