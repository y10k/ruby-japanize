...
部(日本語化) {
  部(:試験) {
    組(:プロセスの操作の試験, 原型: 試験単位::試験事例) {
      ...
      資料('資源の制限値_開けるファイルの数'                  => [ プロセス::資源の制限値_開けるファイルの数,                  Process::RLIMIT_NOFILE ])              if (defined? Process::RLIMIT_NOFILE)
      ...
      資料('資源の制限値_伝文の待ち行列の大きさ'              => [ プロセス::資源の制限値_伝文の待ち行列の大きさ,              Process::RLIMIT_MSGQUEUE ])            if (defined? Process::RLIMIT_MSGQUEUE)
      資料('資源の制限値_後回しにする度合い'                  => [ プロセス::資源の制限値_後回しにする度合い,                  Process::RLIMIT_NICE ])                if (defined? Process::RLIMIT_NICE)
      資料('資源の制限値_実時間の優先度'                      => [ プロセス::資源の制限値_実時間の優先度,                      Process::RLIMIT_RTPRIO ])              if (defined? Process::RLIMIT_RTPRIO)
      資料('資源の制限値_実時間で遮られずに消費できるCPU時間' => [ プロセス::資源の制限値_実時間で遮られずに消費できるCPU時間, Process::RLIMIT_RTTIME ])              if (defined? Process::RLIMIT_RTTIME)
      資料('資源の制限値_待機できるシグナルの数'              => [ プロセス::資源の制限値_待機できるシグナルの数,              Process::RLIMIT_SIGPENDING ])          if (defined? Process::RLIMIT_SIGPENDING)
      ...
      資料('資源の制限値_開けるファイルの数'                  => [ :資源の制限値_開けるファイルの数,                  Process::RLIMIT_NOFILE ])              if (defined? Process::RLIMIT_NOFILE)
      ...
      資料('資源の制限値_伝文の待ち行列の大きさ'              => [ :資源の制限値_伝文の待ち行列の大きさ,              Process::RLIMIT_MSGQUEUE ])            if (defined? Process::RLIMIT_MSGQUEUE)
      資料('資源の制限値_後回しにする度合い'                  => [ :資源の制限値_後回しにする度合い,                  Process::RLIMIT_NICE ])                if (defined? Process::RLIMIT_NICE)
      資料('資源の制限値_実時間の優先度'                      => [ :資源の制限値_実時間の優先度,                      Process::RLIMIT_RTPRIO ])              if (defined? Process::RLIMIT_RTPRIO)
      資料('資源の制限値_実時間で遮られずに消費できるCPU時間' => [ :資源の制限値_実時間で遮られずに消費できるCPU時間, Process::RLIMIT_RTTIME ])              if (defined? Process::RLIMIT_RTTIME)
      資料('資源の制限値_待機できるシグナルの数'              => [ :資源の制限値_待機できるシグナルの数,              Process::RLIMIT_SIGPENDING ])          if (defined? Process::RLIMIT_SIGPENDING)
